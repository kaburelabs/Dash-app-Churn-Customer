...
def create_footer():
    p = html.P(
        children=[
            ...
            html.A(
                "trich.ai | Data Intelligence Solutions",
    ...
    ul1 = html.Div(
        children=[
            ...
            html.Li(
                font_awesome, style={"display": "inline-block", "color": "#ffffff"}
            ),
    ...
    github = html.A(
        children=html.I(
            children=[], className="fab fa-github", style={"color": "black"}
        ),
        title="Repo on GitHub",
        href="https://github.com/kaburelabs/Dash-app-Churn-Customer",
        target="_blank",
    )
...
def header_logo():
    ...
    subtitle = html.Div(
        html.Div(
            [
                html.Span("Churn rate ", className="bold"),
             ...
             customers or subscribers who leave a supplier during a given time period. \
                 It is a possible indicator of customer dissatisfaction, cheaper and/or \
                     better offers from the competition, more successful sales and/or\
                          marketing by the competition, or reasons having to do with the customer life cycle.",
            ],
            className="font-md margin-auto",
        )
    )
...
def paragraphs():
    ...
    paragra = html.Div(
        html.Div(
            [
                html.Span("Revenue churn ", className="bold"),
                "is the monetary amount of \
